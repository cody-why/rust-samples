 ...
 * @LastEditTime: 2023-09-16 18:10:32
 * @Description:
 */
...
mod tests {
    ...
    fn test_avg() {
        ...
        // 貂蝉平均赔率=92.23 真实概率=rtp/平均赔率 =0.010624746
        let pl = [60, 64, 72, 75, 80, 90, 96, 100, 108, 120, 125, 144, 150, 180, 216];
        let weights = [80, 80, 80, 80, 80, 80, 80, 50, 50, 30, 30, 30, 20, 20, 10];
        // 88.4
